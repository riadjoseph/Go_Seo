...
// Generate the regex for level 1 folders
func segmentLevel1() {
	...
	*/
	...
	fmt.Println(purple + "segment1stLevel: Done")
...
func segmentLevel2() {
	...
	fmt.Println(purple + "segment2ndLevel: Done")
	fmt.Println(purple+"\nThe generated regex can be found in the file:", outputFilename)
